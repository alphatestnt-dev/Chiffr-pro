...
'./chifrecopro-v36.js','./chifrecopro-v37.js','./chifrecopro-v38.js','./chifrecopro-v39.js','./chifrecopro-v40.js',
...
if(t.includes('data-chifrecopro-injected="v40"'))return new Response(t,{status:r.status,statusText:r.statusText,headers:r.headers});
const h=new Headers(r.headers);h.delete('content-length');
const files=['partner-v1.js','tool-v1.js','catalog-v2.js','eco-lever-v1.js','ux-v1.js','barometre-pro-v1.js','completion-v1.js','chifrecopro-v15.js','chifrecopro-v22.js','chifrecopro-v23.js','chifrecopro-v24.js','chifrecopro-v25.js','chifrecopro-v26.js','chifrecopro-v27.js','chifrecopro-v28.js','chifrecopro-v29.js','chifrecopro-v31.js','chifrecopro-v32.js','chifrecopro-v33.js','qa-v34.js','chifrecopro-v35.js','chifrecopro-v36.js','chifrecopro-v37.js','chifrecopro-v38.js','chifrecopro-v39.js','chifrecopro-v40.js'];
const injected='<script data-chifrecopro-injected="v40"></script>'+files.map(x=>'<script src="./'+x+'"></script>').join('');
