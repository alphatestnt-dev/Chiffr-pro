...
function installUX(){
 ...
 document.title='Chifr’Eco&Pro — V13';
 document.querySelectorAll('.logo').forEach(x=>x.textContent='Chifr’Eco&Pro');
 document.querySelectorAll('.pill').forEach(x=>{if(x.textContent.trim()==='VERSION 6')x.textContent='VERSION 13'});
